...
`GET '/trivia_api/v1.01/questions?page=${integer}'`
...
`GET '/trivia_api/v1.01/categories/${id}/questions'`
...
`DELETE '/trivia_api/v1.01/questions/${id}'`
...
```json
{
    ...
    'quiz_category': {'type': 'current category', 'id': '1'}
 }
```
